...
export default function Header() {
  return (
    <header className="flex h-[95px] justify-between w-full shrink-0 items-center px-4 md:px-6 z-50">
      <Link href="#" className="ml-[-20px] block md:hidden" prefetch={false}>
        <Image
          alt="logo"
          width={130}
          height={30}
      ...
      <Sheet>
        ...
        <SheetContent side="left">
          {/* <Link
            href="#"
            className="w-[130px] h-[35px] relative"
            prefetch={false}>
            <Image
              alt="logo"
              width={90}
