        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <form className="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <input
              ...
              className="w-full lg:w-1/4 p-3 rounded-md border border-gray-300 text-gray-900 focus:ring-2 focus:ring-orange-400"
            />

            {/* Role Select */}
            <Select>
              <SelectTrigger className="w-full lg:w-1/4 p-3 rounded-md border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-orange-400">
