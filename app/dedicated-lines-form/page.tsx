...
const DedicatedLineForm: React.FC = () => {
                ...
                <div className="col-span-2  text-[12px]">
                  ...
                  <label
                    ...
                    <p className="text-[12px] font-bold cursor-pointer">
                      ...
                      from BRT Logistics related to Conversational messages at
                      the phone number provided above. The SMS frequency may
                      vary. Data rates may apply. For assistance reply HELP.
                      Reply STOP to opt out of receiving text messages. Please
                      review our
                      <Link
                        target="_blank"
...
export default DedicatedLineForm;
